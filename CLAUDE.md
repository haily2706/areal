...
AReal is a Next.js 16 application using the App Router and React 19. It's an AI-powered flashcard application with authentication powered by Clerk and UI components built with shadcn/ui and Tailwind CSS.
